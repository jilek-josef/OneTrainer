#!/usr/bin/env python3
"""
Generate 1024x1024 images using tiled VAE decode.
"""
import os
import sys
import tempfile
...
print("=" * 60)
print("1024x1024 Test with Tiled VAE Decode")
print("=" * 60)
...
# Test: 35 steps, CFG=4.5 (same as test_anima_inference.py)
print("\nGenerating: 35 steps, CFG=4.5 at 1024x1024")
...
# Decode using tiled decode
print("  Decoding with tiled VAE...")
...
pil_image.save(os.path.join(OUT_DIR, "test_1024_35steps_cfg45.png"))
