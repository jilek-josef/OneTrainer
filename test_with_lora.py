...
lora_wrapper = LoRAModuleWrapper(model.transformer, "transformer", config, ["transformer"])
lora_wrapper.load_state_dict(lora_state_dict)
model.transformer_lora = lora_wrapper
...
# Use model's scheduler (like DistillLoRA teacher)
...
pil_image.save(os.path.join(OUT_DIR, "test_with_lora_1024.png"))
