#!/usr/bin/env python3
"""
Test with diffusers pipeline preconditioning.
"""
import os
import sys
import tempfile
...
print("=" * 60)
print("Diffusers Preconditioning Test")
print("=" * 60)
...
# Use fresh scheduler (like diffusers pipeline)
...
# Denoising loop with DIFFUSERS PRECONDITIONING
print(f"Sampling {STEPS} steps with diffusers preconditioning...")
with torch.no_grad():
...
pil_image.save(os.path.join(OUT_DIR, "test_diffusers_preconditioning_1024.png"))
